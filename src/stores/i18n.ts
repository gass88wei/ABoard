...
const t_map: Translations = {
  ...
  "settings.type.text": { zh: "文本", en: "Text" },
  "settings.type.image": { zh: "图片", en: "Image" },
  "settings.type.video": { zh: "视频", en: "Video" },
  "settings.type.file": { zh: "文件", en: "File" },
  "settings.type.richtext": { zh: "富文本", en: "Rich Text" },
  "settings.type.html": { zh: "HTML", en: "HTML" },
